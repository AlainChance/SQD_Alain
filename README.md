...
* [SQD_manual_config.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/SQD_manual_config.ipynb)
* [SQD_C2H4.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/C2H4/SQD_C2H4.ipynb)
* [SQD_C2H4_ibm_fez.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/C2H4_ibm_fez/SQD_C2H4.ipynb)
* [SQD_CH2_Singlet.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/CH2_Singlet/SQD_CH2_Singlet.ipynb)
* [SQD_CH2_Singlet_ibm_fez.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/CH2_Singlet_ibm_fez/SQD_CH2_Singlet.ipynb)
* [SQD_CH2_Triplet.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/CH2_Triplet/SQD_CH2_Triplet.ipynb)
* [SQD_CH2_Triplet_ibm_fez.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/CH2_Triplet_ibm_fez/SQD_CH2_Triplet.ipynb)
* [SQD_CH4.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/CH4/SQD_CH4.ipynb)
* [SQD_CH4_ibm_fez.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/CH4_ibm_fez/SQD_CH4.ipynb)
* [SQD_CO2.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/CO2/SQD_CO2.ipynb)
* [SQD_CO2_ibm_fez.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/CO2_ibm_fez/SQD_CO2.ipynb)
* [SQD_H2O.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/H2O/SQD_H2O.ipynb)
* [SQD_H2O_ibm_fez.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/H2O_ibm_fez/SQD_H2O.ipynb)
* [SQD_LiH.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/LiH/SQD_LiH.ipynb)
* [SQD_LiH_ibm_fez.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/LiH_ibm_fez/SQD_LiH.ipynb)
* [SQD_N2.ipynb](https://https://github.com/AlainChance/SQD_Alain/blob/main/N2/SQD_N2.ipynb)
* [SQD_N2_ibm_fez.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/N2_ibm_fez/SQD_N2.ipynb)
...
The SQD class integrates the [eco2AI](https://github.com/sb-ai-lab/Eco2AI) tracking feature, a python library which accumulates statistics about power consumption and CO2 emission during running code. 
...
[Osama M. Raisuddin, Haimeng Zhang, Mario Motta, Fabian M. Faulstich, From Promise to Practice: Benchmarking Quantum Chemistry on Quantum Hardware, arXiv:2512.01012, 30 Nov 2025](https://doi.org/10.48550/arXiv.2512.01012)
...
[Bounding the subspace dimension](https://qiskit.github.io/qiskit-addon-sqd/how_tos/choose_subspace_dimension.html)
...
Use [SQD_manual_config.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/SQD_manual_config.ipynb) as template.
...
The configuration is automatically saved into a Json configuration file, see for exemple: [SQD_CH2_Triplet.json](https://github.com/AlainChance/SQD_Alain/blob/main/CH2_Triplet_ibm_fez_manual_config/SQD_CH2_Triplet.json).
...
# The Jupyter notebook [SQD_C2H4.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/C2H4/SQD_C2H4.ipynb) finds an approximation to the ethylene $C_2H_4$ molecule in the `sto-6g` basis set
Ethylene is a hydrocarbon that is widely used in the chemical industry.
...
## Analysis of the power consumption across two experiments

**CH2_Singlet_ibm_fez**  
* Jupyter notebook: [SQD_CH2_Singlet.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/CH2_Singlet_ibm_fez/SQD_CH2_Singlet.ipynb)  
* Backend: `ibm_fez`  
* Number of shots: **1,000**  
* Number of qubits: **26**  
* Depth of the ISA quantum circuit: **353**  
* Chemical accuracy reached in **3 iterations**  
* Power consumption analysis: [SQD_power_consumption.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/CH2_Singlet_ibm_fez/SQD_power_consumption.ipynb)  
* Qiskit Runtime usage: **2.00 seconds**  
* Rough estimate of power consumption on the IBM QPU (kWh): **0.0139**  
* Power consumption of classical processing (kWh): **0.0014**  

**CH2_Singlet_ibm_fez_manual_config**  
* Jupyter notebook: [SQD_CH2_Singlet.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/CH2_Singlet_ibm_fez_manual_config/SQD_CH2_Singlet.ipynb)
* Backend: `ibm_fez`  
* Number of shots: **50,000**  
* Number of qubits: **26**  
* Depth of the ISA quantum circuit: **355**  
* Chemical accuracy reached in **2 iterations**  
* Power consumption analysis: [SQD_power_consumption.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/CH2_Singlet_ibm_fez_manual_config/SQD_power_consumption.ipynb)  
* Qiskit Runtime usage: **15.00 seconds**  
* Rough estimate of power consumption on the IBM QPU (kWh): **0.1042**  
* Power consumption of classical processing (kWh): **0.0016**  

The first experiment consumes about **10× less energy on the QPU** than the second one, while using roughly the same amount of energy for classical processing on the same laptop.
...
![plot_energy_and_occupancy.png](https://github.com/AlainChance/SQD_Alain/blob/main/CH2_Triplet_ibm_fez_manual_config/plot_energy_and_occupancy.png)
The first plot shows an estimation of the ground state energy within $\approx$ `1 milli-Hartree (mHa)`. 
...
# The Jupyter notebook [SQD_CO2.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/CO2/SQD_CO2.ipynb) finds an approximation to the ground state of the $CO_2$ molecule at equilibrium in the `sto-6g` basis set.
...
**C02**  
* Jupyter notebook: [SQD_CO2.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/CO2/SQD_CO2.ipynb)
* Run on QPU: `False`
* **Generating 10k samples drawn from the uniform distribution**   
* Chemical accuracy reached in **4 iterations**  
* Power consumption analysis: [SQD_power_consumption.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/CO2/SQD_power_consumption.ipynb)   
* Rough estimate of power consumption on the IBM QPU (kWh): **0.0**  
* Power consumption of classical processing (kWh): **0.0173**  

**CO2_ibm_fez**  
* Jupyter notebook: [SQD_CO2.ipynb](https://github.com/AlainChance/SQD_Alain/tree/main/CO2_ibm_fez)
* Backend: `ibm_fez`  
* Number of shots: **75,000**  
* Number of qubits: **30**  
* Depth of the ISA quantum circuit: **371**  
* Chemical accuracy reached in **4 iterations**  
* Power consumption analysis: [SQD_power_consumption.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/CO2_ibm_fez/SQD_power_consumption.ipynb)  
* Qiskit Runtime usage: **21.00 seconds**  
* Rough estimate of power consumption on the IBM QPU (kWh): **0.1458**  
...
# The Jupyter notebook [SQD_N2.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/N2/SQD_N2.ipynb) finds an approximation to the ground state of the $N_2$ molecule.
...
[SQD-2] Osama M. Raisuddin, Haimeng Zhang, Mario Motta, Fabian M. Faulstich, From Promise to Practice: Benchmarking Quantum Chemistry on Quantum Hardware, arXiv:2512.01012 [quant-ph], 30 Nov 2025, 
https://doi.org/10.48550/arXiv.2512.01012

[SQD-3] IBM Quantum Webinar Series: Quantum-Centric Supercomputing Algorithms and Use Cases, July 2025, https://www.youtube.com/watch?v=gkyH6X_yQyA

[SQD-4] Improving energy estimation of a chemistry Hamiltonian with SQD, https://github.com/Qiskit/qiskit-addon-sqd/blob/main/docs/tutorials/01_chemistry_hamiltonian.ipynb

[SQD-5] Sample-based Quantum Diagonalization (SQD), Quantum diagonalization algorithms, https://quantum.cloud.ibm.com/learning/en/courses/quantum-diagonalization-algorithms/sqd-overview

[SQD-6] Quantum diagonalization algorithms, IBM Quantum Platform, Quantum Learning, https://quantum.cloud.ibm.com/learning/en/courses/quantum-diagonalization-algorithms

[SQD-7] Sample-based quantum diagonalization of a chemistry Hamiltonian, https://quantum.cloud.ibm.com/docs/en/tutorials/sample-based-quantum-diagonalization

[SQD-8] Samuele Piccinelli et al., Quantum chemistry with provable convergence via randomized sample-based quantum diagonalization, 4 Aug 2025, arXiv:2508.02578 [quant-ph], https://doi.org/10.48550/arXiv.2508.02578

[SQD-9] Antonio Mezzacapo: Quantum diagonalization methods for lattice models, IQuS - The InQubator For Quantum Simulation, Feb 19, 2025, https://www.youtube.com/watch?v=b1fhh71hY2g

[SQD-10] Javier Robledo-Moreno, Gavin Jones, Roberto Lo Nardo, Robert Davis, Lockheed Martin & IBM combine quantum computing with classical HPC in new research, IBM Quantum Research Blog, 22 May 2025, https://www.ibm.com/quantum/blog/lockheed-martin-sqd

[SQD-11] Ieva Liepuoniute, Kirstin D. Doney, Javier Robledo Moreno, Joshua A. Job, William S. Friend, Gavin O. Jones, Quantum-Centric Computational Study of Methylene Singlet and Triplet States, J. Chem. Theory Comput. 2025, 21, 10, 5062–5070, https://doi.org/10.1021/acs.jctc.5c00075

[SQD-12] Danil Kaliakin, Akhil Shajan, Fangchun Liang, Kenneth M. Merz Jr., Implicit Solvent Sample-Based Quantum Diagonalization,J. Phys. Chem. B 2025, 129, 23, 5788–5796, https://doi.org/10.1021/acs.jpcb.5c01030

[SQD-13] Deploy and Run the SQD IEF-PCM Function Template, qiskit-function-templates/chemistry/sqd_pcm/deploy_and_run.ipynb, https://github.com/qiskit-community/qiskit-function-templates/blob/main/chemistry/sqd_pcm/deploy_and_run.ipynb

[SQD-14] J. Robledo-Moreno et al., "Chemistry Beyond Exact Solutions on a Quantum-Centric Supercomputer" (2024), arXiv:quant-ph/2405.05068, https://arxiv.org/abs/2405.05068

[SQD-15] M. Motta et al., “Bridging physical intuition and hardware efficiency for correlated electronic states: the local unitary cluster Jastrow ansatz for electronic structure” (2023). Chem. Sci., 2023, 14, 11213, https://pubs.rsc.org/en/content/articlehtml/2023/sc/d3sc02516k

[SQD-16] Keita Kanno, Masaya Kohda, Ryosuke Imai, Sho Koh, Kosuke Mitarai, Wataru Mizukami, Yuya O. Nakagawa, Quantum-Selected Configuration Interaction: classical diagonalization of Hamiltonians in subspaces selected by quantum computers, arXiv:2302.11320 [quant-ph], https://doi.org/10.48550/arXiv.2302.11320

[SQD-17] Introduction to Qiskit patterns, https://quantum.cloud.ibm.com/docs/en/guides/intro-to-patterns
