...
# What is Sample-based quantum diagonalization (SQD)?
...
In the talk by Kevin Sung and Mario Motta, [Simulation Landscape Overview and Capabilities | QDC 2025](https://www.youtube.com/watch?v=saO-OdwBDwk), there is a particularly striking slide titled “Algorithms move the needle” (around 10:00). The slide presents a clear timeline of progress in quantum chemistry simulations over the past decade: early advances driven by VQE, followed by incremental algorithmic refinements, and then a sharp jump enabled by new algorithm discovery, explicitly highlighting Sample‑based Quantum Diagonalization (SQD).

The message is unambiguous: while VQE played a foundational role in the NISQ era, scalability and practical chemistry applications are now being unlocked by SQD and related Krylov‑based methods. This aligns closely with IBM’s recent blog posts and broader research narrative.
...
| Metric | 1 | 2 | 3 | 4 | 5 |
|---------------|--------|---------|---------|---------|---------|
| **Basis set**                        | 6-31G     | 6-31G     | 6-31G     | cc-pVDZ    | cc-pVDZ   |
| **Backend**                          | No QPU    | ibm_fez   | ibm_fez   | No QPU     | ibm_fez   |
| **Number of shots**                  | 0         | 1,000     | 50,000    | 0          | 50,000    |
| **Samples ($\times 10^3$)**          | 10        | 0         | 0         | 5,000      |0          |
| **Number of qubits**                 | 0         | 26        | 26        | 0          | 48        |
| **Circuit depth (ISA)**              | 0         | 353       | 355       | 0          | 635       |
| **Exact energy (Ha)**                | -38.94147 | -38.94147 | -38.94147 | -39.02174  | -39.02174 |
| **SQD energy (Ha)**                  | -38.94144 | -38.94138 | -38.94141 | -39.02139  | -39.02149 |
| **Chemical accuracy iterations**     | 2         | 3         | 1         | 6          | 5         |
| **Qiskit Runtime usage (s)**         | 0.00      | 2.00      | 15.00     | 0.00       | 16.00     |
| **IBM QPU power (kWh)**              | 0.0000    | 0.0139    | 0.1042    | 0.0000     | 0.1111    |
| **Classical processing duration (h)**| 0.0256    | 0.0276    | 0.0324    | 4.3108     | 1.6587    |
| **Classical processing power (kWh)** | 0.0013    | 0.0014    | 0.0013    | 0.1223     | 0.0887    |
...
## SQD_CH2_Triplet - Analysis across five experiments
* **Assumption:**
  A ballpark estimate for a typical modern IBM-class superconducting quantum computer (including cryogenics and supporting infrastructure, while idle or lightly used) is approximately **15–25 kW**.
  Source: [*Green Quantum Computing*, Capgemini, 8 May 2023](https://www.capgemini.com/insights/expert-perspectives/green-quantum-computing/).
* Classical simulation by generating random samples drawn from a uniform distribution. *“While this approach may work for small problems, it tends to fail for larger and more practical problems.”* See [A Case Against Uniform Sampling](https://quantum.cloud.ibm.com/learning/en/courses/quantum-diagonalization-algorithms/sqd-overview#32-a-case-against-uniform-sampling).
...
5. [CH2_Triplet_cc-pvdz_ibm_fez/SQD_CH2_Triplet.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/CH2_Triplet/CH2_Triplet_cc-pvdz_ibm_fez/SQD_CH2_Triplet.ipynb)
...
| **Basis set**                        | 6-31G     | 6-31G     | 6-31G     | cc-pVDZ    | cc-pVDZ   |
| **Backend**                          | No QPU    | ibm_fez   | ibm_fez   | No QPU     | ibm_fez   |
| **Number of shots ($\times 10^3$)**  | 0         | 1         | 50        | 0          | 2,000     |
| **Samples ($\times 10^3$)**          | 10        | 0         | 0         | 10,000     | 0         |
| **Number of qubits**                 | 0         | 26        | 26        | 0          | 46        |
| **Circuit depth (ISA)**              | 0         | 1515      | 1380      | 0          | 1898      |
| **Exact energy (Ha)**                | -38.96994 | -38.96994 | -38.96994 | -39.03015  | -39.03015 |
| **SQD energy (Ha)**                  | -38.96979 | -38.96964 | -38.96986 | -39.02969  | -39.02983 |
| **Chemical accuracy iterations**     | 5         | 6         | 4         | 8          | 9         |
| **Qiskit Runtime usage (s)**         | 0.00      | 2.00      | 17.00     | 0.00       | 637.00    |
| **IBM QPU power (kWh)**              | 0.0000    | 0.0139    | 0.1181    | 0.0000     | 4.4236    |
| **Classical processing duration (h)**| 0.0302    | 0.0260    | 0.0423    | 7.4716     | 2.4073    |
| **Classical processing power (kWh)** | 0.0015    | 0.0013    | 0.0016    | 0.1334     | 0.0467    |

In the `6-31G` basis set, the first simulation consumes the least energy, while using roughly the same amount of energy for classical processing on the same laptop. The third simulation achieves chemical accuracy with the fewest iterations.

In the `cc-pVDZ` basis set, the fourth classical simulation consumes the least energy but requires a prohibitive classical processing time. The fifth simulation achieves the best accuracy and requires three times less classical processing time.
...
[SQD-2] Kevin Sung and Mario Motta, Simulation Landscape Overview and Capabilities | QDC 2025, https://www.youtube.com/watch?v=saO-OdwBDwk

[SQD-3] Kennie Merz & Danil Kaliakin | Implicit Solvent SQD | QDC 2025, Qiskit, https://www.youtube.com/watch?v=u5I34KMZBHU

[SQD-4] Osama M. Raisuddin, Haimeng Zhang, Mario Motta, Fabian M. Faulstich, From Promise to Practice: Benchmarking Quantum Chemistry on Quantum Hardware, arXiv:2512.01012 [quant-ph], 30 Nov 2025, https://doi.org/10.48550/arXiv.2512.01012

[SQD-5] Javier Robledo-Moreno et al., Chemistry Beyond the Scale of Exact Diagonalization on a Quantum-Centric Supercomputer, arXiv:2405.05068 [quant-ph], 13 Jul 2025, https://doi.org/10.48550/arXiv.2405.05068

[SQD-6] IBM Quantum Webinar Series: Quantum-Centric Supercomputing Algorithms and Use Cases, July 2025, https://www.youtube.com/watch?v=gkyH6X_yQyA

[SQD-7] Improving energy estimation of a chemistry Hamiltonian with SQD, https://github.com/Qiskit/qiskit-addon-sqd/blob/main/docs/tutorials/01_chemistry_hamiltonian.ipynb

[SQD-8] Sample-based Quantum Diagonalization (SQD), Quantum diagonalization algorithms, https://quantum.cloud.ibm.com/learning/en/courses/quantum-diagonalization-algorithms/sqd-overview

[SQD-9] Quantum diagonalization algorithms, IBM Quantum Platform, Quantum Learning, https://quantum.cloud.ibm.com/learning/en/courses/quantum-diagonalization-algorithms

[SQD-10] Sample-based quantum diagonalization of a chemistry Hamiltonian, https://quantum.cloud.ibm.com/docs/en/tutorials/sample-based-quantum-diagonalization

[SQD-11] Samuele Piccinelli et al., Quantum chemistry with provable convergence via randomized sample-based quantum diagonalization, 4 Aug 2025, arXiv:2508.02578 [quant-ph], https://doi.org/10.48550/arXiv.2508.02578

[SQD-12] Antonio Mezzacapo: Quantum diagonalization methods for lattice models, IQuS - The InQubator For Quantum Simulation, Feb 19, 2025, https://www.youtube.com/watch?v=b1fhh71hY2g

[SQD-13] Javier Robledo-Moreno, Gavin Jones, Roberto Lo Nardo, Robert Davis, Lockheed Martin & IBM combine quantum computing with classical HPC in new research, IBM Quantum Research Blog, 22 May 2025, https://www.ibm.com/quantum/blog/lockheed-martin-sqd

[SQD-14] Ieva Liepuoniute, Kirstin D. Doney, Javier Robledo Moreno, Joshua A. Job, William S. Friend, Gavin O. Jones, Quantum-Centric Computational Study of Methylene Singlet and Triplet States, J. Chem. Theory Comput. 2025, 21, 10, 5062–5070, https://doi.org/10.1021/acs.jctc.5c00075

[SQD-15] Danil Kaliakin, Akhil Shajan, Fangchun Liang, Kenneth M. Merz Jr., Implicit Solvent Sample-Based Quantum Diagonalization,J. Phys. Chem. B 2025, 129, 23, 5788–5796, https://doi.org/10.1021/acs.jpcb.5c01030

[SQD-16] Deploy and Run the SQD IEF-PCM Function Template, qiskit-function-templates/chemistry/sqd_pcm/deploy_and_run.ipynb, https://github.com/qiskit-community/qiskit-function-templates/blob/main/chemistry/sqd_pcm/deploy_and_run.ipynb

[SQD-17] J. Robledo-Moreno et al., "Chemistry Beyond Exact Solutions on a Quantum-Centric Supercomputer" (2024), arXiv:quant-ph/2405.05068, https://arxiv.org/abs/2405.05068

[SQD-18] M. Motta et al., “Bridging physical intuition and hardware efficiency for correlated electronic states: the local unitary cluster Jastrow ansatz for electronic structure” (2023). Chem. Sci., 2023, 14, 11213, https://pubs.rsc.org/en/content/articlehtml/2023/sc/d3sc02516k

[SQD-19] Keita Kanno, Masaya Kohda, Ryosuke Imai, Sho Koh, Kosuke Mitarai, Wataru Mizukami, Yuya O. Nakagawa, Quantum-Selected Configuration Interaction: classical diagonalization of Hamiltonians in subspaces selected by quantum computers, arXiv:2302.11320 [quant-ph], https://doi.org/10.48550/arXiv.2302.11320

[SQD_20] Qiskit addons team, Bounding the subspace dimension in Qiskit addon: sample-based quantum diagonalization (SQD), https://qiskit.github.io/qiskit-addon-sqd/how_tos/choose_subspace_dimension.html
