...
See an example configuration here: [CH2_Triplet_ibm_fez_manual
/SQD_CH2_Triplet.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/CH2_Triplet_ibm_fez_manual/SQD_CH2_Triplet.ipynb)
...
* `nsamples`: number of random samples (x1000) to be drawn from a uniform distribution.
...
* Slider `Number of samples (x1000)`: select the number of random samples (x1000) to be drawn from a uniform distribution.

See for exemple: ![CH2_Singlet_cc-pvdz/SQD_config_and_run.png](https://github.com/AlainChance/SQD_Alain/blob/main/CH2_Singlet_cc-pvdz/SQD_config_and_run.png)
...
See for exemple: ![CH2_Singlet_cc-pvdz_ibm_fez/SQD_config_and_run.png](https://github.com/AlainChance/SQD_Alain/blob/main/CH2_Singlet_cc-pvdz_ibm_fez/SQD_config_and_run.png)

### Run simulation
Click on the button **Save SQD configuration into a Json file and run simulation**.

The configuration is automatically saved into a Json configuration file, see for exemple: [SQD_CH2_Triplet.json](https://github.com/AlainChance/SQD_Alain/blob/main/CH2_Triplet_ibm_fez_manual/SQD_CH2_Triplet.json).
...
See for example: ![CH2_Triplet_ibm_fez Status window](https://github.com/AlainChance/SQD_Alain/blob/main/CH2_Triplet_ibm_fez/CH2_Triplet_ibm_fez%20-%20Gradio%20status%20window.png)
...
See for exemple: [CH2_Triplet_ibm_fez / SQD_config_and_run.png](https://github.com/AlainChance/SQD_Alain/blob/main/CH2_Triplet_ibm_fez/SQD_config_and_run.png)
...
* [C2H4/SQD_C2H4.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/C2H4/SQD_C2H4.ipynb)
* [C2H4_ibm_fez/SQD_C2H4.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/C2H4_ibm_fez/SQD_C2H4.ipynb)
* [C2H4_ibm_fez_manual/SQD_C2H4.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/C2H4_ibm_fez_manual/SQD_C2H4.ipynb)

## [C2H4_ibm_fez/SQD_C2H4.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/C2H4_ibm_fez/SQD_C2H4.ipynb) finds an approximation to the ethylene $C_2H_4$ molecule in the `sto-6g` basis set
...
![SQD_config_and_run.png](https://github.com/AlainChance/SQD_Alain/blob/main/C2H4_ibm_fez/SQD_config_and_run.png)

![plot_energy_and_occupancy.png](https://github.com/AlainChance/SQD_Alain/blob/main/C2H4_ibm_fez/plot_energy_and_occupancy.png)
...
* [CH2_Singlet/SQD_CH2_Singlet.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/CH2_Singlet/SQD_CH2_Singlet.ipynb)
* [CH2_Singlet_ibm_fez/SQD_CH2_Singlet.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/CH2_Singlet_ibm_fez/SQD_CH2_Singlet.ipynb)
* [CH2_Singlet_ibm_fez_manual/SQD_CH2_Singlet.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/CH2_Singlet_ibm_fez_manual/SQD_CH2_Singlet.ipynb)
* [CH2_Singlet_cc-pvdz/SQD_CH2_Singlet.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/CH2_Singlet_cc-pvdz/SQD_CH2_Singlet.ipynb)
* [CH2_Singlet_cc-pvdz_ibm_fez/SQD_CH2_Singlet.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/CH2_Singlet_cc-pvdz_ibm_fez/SQD_CH2_Singlet.ipynb)
...
## [CH2_Singlet_ibm_fez/SQD_CH2_Singlet.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/CH2_Singlet_ibm_fez/SQD_CH2_Singlet.ipynb) finds an approximation to the carbene singlet state $CH_2$ molecule in the `6-31G` basis set.
...
![SQD_config_and_run.png](https://github.com/AlainChance/SQD_Alain/blob/main/CH2_Singlet_ibm_fez/SQD_config_and_run.png)

![plot_energy_and_occupancy.png](https://github.com/AlainChance/SQD_Alain/blob/main/CH2_Singlet_ibm_fez/plot_energy_and_occupancy.png)
...
## [CH2_Singlet_cc-pvdz_ibm_fez/SQD_CH2_Singlet.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/CH2_Singlet_cc-pvdz_ibm_fez/SQD_CH2_Singlet.ipynb) finds an approximation to the carbene singlet state $CH_2$ molecule in the `cc-pVDZ` basis set.
The field `Json configuration filename` is initialized with the name of first file ending with `.json` in the current directory or `None` if there is none. Check that it contains the value `SQD_CH2_Singlet.json` and then click on the button **Load configuration from a Json file**.
...
![SQD_config_and_run.png](https://github.com/AlainChance/SQD_Alain/blob/main/CH2_Singlet_cc-pvdz_ibm_fez/SQD_config_and_run.png)

![plot_energy_and_occupancy.png](https://github.com/AlainChance/SQD_Alain/blob/main/CH2_Singlet_cc-pvdz_ibm_fez/plot_energy_and_occupancy.png)
The first plot shows an estimation of the ground state energy within $\approx$ `1 milli-Hartree (mHa)`.
...
1. [CH2_Singlet/SQD_CH2_Singlet.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/CH2_Singlet/SQD_CH2_Singlet.ipynb) 

2. [CH2_Singlet_ibm_fez/SQD_CH2_Singlet.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/CH2_Singlet_ibm_fez/SQD_CH2_Singlet.ipynb)

3. [CH2_Singlet_ibm_fez_manual/SQD_CH2_Singlet.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/CH2_Singlet_ibm_fez_manual/SQD_CH2_Singlet.ipynb)

4. [CH2_Singlet_cc-pvdz/SQD_CH2_Singlet.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/CH2_Singlet_cc-pvdz/SQD_CH2_Singlet.ipynb)

5. [CH2_Singlet_cc-pvdz_ibm_fez/SQD_CH2_Singlet.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/CH2_Singlet_cc-pvdz_ibm_fez/SQD_CH2_Singlet.ipynb)
...
* [CH2_Triplet/SQD_CH2_Triplet.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/CH2_Triplet/SQD_CH2_Triplet.ipynb)
* [CH2_Triplet_ibm_fez/SQD_CH2_Triplet.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/CH2_Triplet_ibm_fez/SQD_CH2_Triplet.ipynb)
* [CH2_Triplet_ibm_fez_manual/SQD_CH2_Triplet.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/CH2_Triplet_ibm_fez_manual/SQD_CH2_Triplet.ipynb)
* [CH2_Triplet_cc-pvdz/SQD_CH2_Triplet.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/CH2_Triplet_cc-pvdz/SQD_CH2_Triplet.ipynb)
...
## [CH2_Triplet_ibm_fez/SQD_CH2_Triplet.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/CH2_Triplet_ibm_fez/SQD_CH2_Triplet.ipynb) finds an approximation to the ground state of the triplet $CH_2$ molecule in the `6-31G` basis set.
...
![SQD_config_and_run.png](https://github.com/AlainChance/SQD_Alain/blob/main/CH2_Triplet_ibm_fez/SQD_config_and_run.png)

![plot_energy_and_occupancy.png](https://github.com/AlainChance/SQD_Alain/blob/main/CH2_Triplet_ibm_fez/plot_energy_and_occupancy.png)
The first plot shows an estimation of the ground state energy within $\approx$ `1 milli-Hartree (mHa)`. 
...
## [CH2_Triplet_cc-pvdz/SQD_CH2_Triplet.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/CH2_Triplet_cc-pvdz/SQD_CH2_Triplet.ipynb) finds an approximation to the ground state of the triplet $CH_2$ molecule in the `cc-pVDZ` basis set.
...
![SQD_config_and_run.png](https://github.com/AlainChance/SQD_Alain/blob/main/CH2_Triplet_cc-pvdz/SQD_config_and_run.png)

![plot_energy_and_occupancy.png](https://github.com/AlainChance/SQD_Alain/blob/main/CH2_Triplet_cc-pvdz/plot_energy_and_occupancy.png)
The first plot shows an estimation of the ground state energy within $\approx$ `1 milli-Hartree (mHa)`. 
...
1. [CH2_Triplet/SQD_CH2_Triplet.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/CH2_Triplet/SQD_CH2_Triplet.ipynb) 

2. [CH2_Triplet_ibm_fez/SQD_CH2_Triplet.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/CH2_Triplet_ibm_fez/SQD_CH2_Triplet.ipynb)

3. [CH2_Triplet_ibm_fez_manual/SQD_CH2_Triplet.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/CH2_Triplet_ibm_fez_manual/SQD_CH2_Triplet.ipynb)

4. [CH2_Triplet_cc-pvdz/SQD_CH2_Triplet.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/CH2_Triplet_cc-pvdz/SQD_CH2_Triplet.ipynb)
...
\hline
\text{Number of qubits} & 0 & 26 & 26 & 46\\
\hline
\text{Circuit depth (ISA)} & 0 & 1515 & 1380 & 142\\
\hline
...
* [CH4/SQD_CH4.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/CH4/SQD_CH4.ipynb)
* [CH4_ibm_fez/SQD_CH4.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/CH4_ibm_fez/SQD_CH4.ipynb)
* [CH4_ibm_fez_manual/SQD_CH4.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/CH4_ibm_fez_manual/SQD_CH4.ipynb)

## [CH4_ibm_fez/SQD_CH4.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/CH4_ibm_fez/SQD_CH4.ipynb) finds an approximation to the ground state of the $CH_4$ molecule at equilibrium in the `6-31g` basis set.
...
![SQD_config_and_run.png](https://github.com/AlainChance/SQD_Alain/blob/main/CH4_ibm_fez/SQD_config_and_run.png)

![plot_energy_and_occupancy.png](https://github.com/AlainChance/SQD_Alain/blob/main/CH4_ibm_fez/plot_energy_and_occupancy.png)
The first plot shows an estimation of the ground state energy within $\approx$ `1 milli-Hartree (mHa)`. 
...
* [CO2/SQD_CO2.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/CO2/SQD_CO2.ipynb)
* [CO2_ibm_fez/SQD_CO2.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/CO2_ibm_fez/SQD_CO2.ipynb)
...
## [CO2_ibm_fez/SQD_CO2.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/CO2_ibm_fez/SQD_CO2.ipynb) finds an approximation to the ground state of the $CO_2$ molecule at equilibrium in the `sto-6g` basis set.
...
![SQD_config_and_run.png](https://github.com/AlainChance/SQD_Alain/blob/main/CO2_ibm_fez/SQD_config_and_run.png)

![plot_energy_and_occupancy](https://github.com/AlainChance/SQD_Alain/blob/main/CO2_ibm_fez/plot_energy_and_occupancy.png)
...
1. [CO2/SQD_CO2.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/CO2/SQD_CO2.ipynb)  

2. [CO2_ibm_fez/SQD_CO2.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/CO2_ibm_fez/SQD_CO2.ipynb)
...
# Water $H_2O$ molecule
* [H2O/SQD_H2O.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/H2O/SQD_H2O.ipynb)
* [H2O_ibm_fez/SQD_H2O.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/H2O_ibm_fez/SQD_H2O.ipynb)
* [H2O_ibm_fez_manual/SQD_H2O.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/H2O_ibm_fez_manual/SQD_H2O.ipynb)

## [H2O_ibm_fez/SQD_H2O.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/H2O_ibm_fez/SQD_H2O.ipynb) finds an approximation to the ground state of the $H_2O$ molecule.
...
![SQD_config_and_run.png](https://github.com/AlainChance/SQD_Alain/blob/main/H2O_ibm_fez/SQD_config_and_run.png)

![plot_energy_and_occupancy.png](https://github.com/AlainChance/SQD_Alain/blob/main/H2O_ibm_fez/plot_energy_and_occupancy.png)
The first plot shows an estimation of the ground state energy within $\approx$ `1 milli-Hartree (mHa)`.

The second plot shows the average occupancy of each spatial orbital after the final iteration. Both the spin-up and spin-down electrons occupy the first five orbitals with high probability.

## Lithium hydride $LiH$ molecule
* [LiH/SQD_LiH.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/LiH/SQD_LiH.ipynb)
* [LiH_ibm_fez/SQD_LiH.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/LiH_ibm_fez/SQD_LiH.ipynb)
* [LiH_ibm_fez_manual/SQD_LiH.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/LiH_ibm_fez_manual/SQD_LiH.ipynb)

## [SQD_LiH.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/LiH/SQD_LiH.ipynb) finds an approximation to the ground state of the $LiH$ molecule.
...
![SQD_config_and_run.png](https://github.com/AlainChance/SQD_Alain/blob/main/LiH_ibm_fez/SQD_config_and_run.png)

![plot_energy_and_occupancy.png](https://github.com/AlainChance/SQD_Alain/blob/main/LiH_ibm_fez/plot_energy_and_occupancy.png)
The first plot shows an estimation of the ground state energy within $\approx$ `1 milli-Hartree (mHa)`. 
...
* [N2/SQD_N2.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/N2/SQD_N2.ipynb)
* [N2_ibm_fez/SQD_N2.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/N2_ibm_fez/SQD_N2.ipynb)
* [N2_ibm_fez_manual/SQD_N2.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/N2_ibm_fez_manual/SQD_N2.ipynb)
* [N2_cc-pvdz_ibm_fez/SQD_N2.ipynb](https://github.com/AlainChance/SQD_Alain/tree/main/N2_cc-pvdz_ibm_fez)
* [N2_cc-pvdz_ibm_fez_manual/SQD_N2.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/N2_cc-pvdz_ibm_fez_manual/SQD_N2.ipynb)
...
## [N2_ibm_fez/SQD_N2.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/N2_ibm_fez/SQD_N2.ipynb) finds an approximation to the ground state of the nitrogen gas $N_2$ molecule in the `6-31g` basis set.
...
![SQD_config_and_run.png](https://github.com/AlainChance/SQD_Alain/blob/main/N2_ibm_fez/SQD_config_and_run.png)

![plot_energy_and_occupancy](https://github.com/AlainChance/SQD_Alain/blob/main/N2_ibm_fez/plot_energy_and_occupancy.png)
The first plot shows an estimation of the ground state energy within $\approx$ `1 milli-Hartree (mHa)`.

The second plot shows the average occupancy of each spatial orbital after the final iteration. Both the spin-up and spin-down electrons occupy the first five orbitals with high probability.

## [N2_cc-pvdz_ibm_fez/SQD_N2.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/N2_cc-pvdz_ibm_fez_manual/SQD_N2.ipynb) finds an approximation to the ground state of the nitrogen gas $N_2$ molecule in the `cc-pVDZ` basis set.
The field `Json configuration filename` is initialized with the name of first file ending with `.json` in the current directory or `None` if there is none. Check that it contains the value `SQD_N2.json` and then click on the button **Load configuration from a Json file**.
...
![SQD_config_and_run.png](https://github.com/AlainChance/SQD_Alain/blob/main/N2_cc-pvdz_ibm_fez/SQD_config_and_run.png)

![plot_energy_and_occupancy](https://github.com/AlainChance/SQD_Alain/blob/main/N2_cc-pvdz_ibm_fez/plot_energy_and_occupancy.png)
...
## [N2_cc-pvdz_ibm_fez_manual/SQD_N2.ipynb](https://github.com/AlainChance/SQD_Alain/blob/main/N2_cc-pvdz_ibm_fez_manual/SQD_N2.ipynb) finds an approximation to the ground state of the nitrogen gas $N_2$ molecule in the `cc-pVDZ` basis set.
...
![plot_energy_and_occupancy](https://github.com/AlainChance/SQD_Alain/blob/main/N2_cc-pvdz_ibm_fez_manual/plot_energy_and_occupancy.png)
